...
class EarthImageViewModel (
    ...
    private val earthPhoto: Retrofit = Retrofit()
    ) : ViewModel() {
        ...
        fun sendRequestImage(year: String, month: String, day: String, png:String, imageCode:String, ) {
            ...
            if (com.homework.nasapicture.BuildConfig.NASA_API_KEY.isNullOrBlank()) {
                ...
                earthPhoto.getRetrofit().getEarthImage(year, month, day, png, imageCode, com.homework.nasapicture.BuildConfig.NASA_API_KEY)
                    .enqueue(callback)
            }
        }
